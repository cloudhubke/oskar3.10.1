...
function checkoutCommunity
  ...
  and git clone --progress --single-branch --branch $RELEASE_TAG https://@github.com/arangodb/arangodb ArangoDB-$RELEASE_TAG
...
function checkoutEnterprise
  ...
  and git clone --progress --single-branch --branch $RELEASE_TAG https://@github.com/arangodb/enterprise enterprise
  or begin popd; return 1; end
  popd
end
...
function checkoutStarter
  ...
  pushd $INNERWORKDIR/CompleteTar
  and git clone --progress --single-branch --branch $STARTER_REV https://@github.com/arangodb-helper/arangodb Starter-$STARTER_REV
  or begin popd; return 1; end
  popd
end
...
function checkoutSyncer
  ...
  pushd $INNERWORKDIR/CompleteTar
  and git clone --progress --single-branch --branch $SYNCER_REV https://@github.com/arangodb/arangosync arangosync-$SYNCER_REV
  or begin popd; return 1; end
  popd
end
...
function checkoutOskar
  echo "Checkout OSKAR"
  pushd $INNERWORKDIR/CompleteTar
  and git clone --progress --single-branch --branch master https://@github.com/arangodb/oskar
  or begin popd; return 1; end
  popd
end
